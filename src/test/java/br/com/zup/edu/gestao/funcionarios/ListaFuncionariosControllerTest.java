...
class ListaFuncionariosControllerTest extends SpringBootIntegrationTest {
    ...
    @Test
    public void naoDeveListarTodosOsFuncionarios_quandoTokenNaoEnviado() throws Exception {
        // cenário
        List.of(
            new Funcionario("Rafael", "188.332.250-20", Cargo.TESTADOR, new BigDecimal("2.99")),
            new Funcionario("Alberto", "525.894.650-92", Cargo.GERENTE, new BigDecimal("1.99")),
    ...
    @Test
    public void naoDeveListarTodosOsFuncionarios_quandoTokenNaoPossuiEscopoApropriado() throws Exception {
        // cenário
        List.of(
            new Funcionario("Rafael", "188.332.250-20", Cargo.TESTADOR, new BigDecimal("2.99")),
            new Funcionario("Alberto", "525.894.650-92", Cargo.GERENTE, new BigDecimal("1.99")),
