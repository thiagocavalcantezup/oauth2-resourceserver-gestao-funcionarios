...
class NovoFuncionarioControllerTest extends SpringBootIntegrationTest {
    ...
    @Test
    public void deveCadastrarNovoFuncionario_quandoAccessTokenNaoEnviado() throws Exception {
        // cenário
        NovoFuncionarioRequest novoFuncionario = new NovoFuncionarioRequest("Alberto",
                "785.547.810-82", Cargo.GERENTE, new BigDecimal("10981.99"));
    ...
    @Test
    public void deveCadastrarNovoFuncionario_quandoAccessTokenNaoPossuiScopeApropriado() throws Exception {
        // cenário
        NovoFuncionarioRequest novoFuncionario = new NovoFuncionarioRequest("Alberto",
                "785.547.810-82", Cargo.GERENTE, new BigDecimal("10981.99"));
